...
function App() {
    ...
    useEffect(() => {
        ...
        setIsLoading(true);
        fetch(
            `https://pixabay.com/api/?key=32059253-966ef05bcacd8e8b4a60b7ffb&image_type=photo&orientation=vertical&safesearch=true&page=${
                currentPage + 1
            }&per_page=20&order=${sortBy}&q=${query}&category=${category}`,
            { cache: "reload" }
        )
