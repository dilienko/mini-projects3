...
function Greeting({
    ...
    const handleClick = () => {
        if ((category && difficultyLvl) || quizCode) {
            ...
            swal({
                title: "Select a category and difficulty level or enter quiz code",
                icon: "error",
            });
        }
    };
    ...
    return (
        <div className='greeting'>
            <div className='greeting__logo'>
                <img src='https://i.postimg.cc/9XvckkJw/logo.png' alt='logo' />
            </div>
            <h1 className='greeting__header'>Welcome to QuizApp</h1>

            <p className='greeting__text'>
                Select a quiz category and difficulty level or enter quiz code
            </p>
            ...
            <button className='greeting__button' onClick={handleClick}>
                Start Quiz
            </button>
        </div>
    );
