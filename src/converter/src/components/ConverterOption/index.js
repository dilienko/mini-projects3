...
function ConverterOption({value, setValue, label}){
    ...
    const options = [
        { value: 'USD', label: 'USD - US Dollar', image: `${process.env.PUBLIC_URL}/assets/images/USD.svg` },
        { value: 'UAH', label: 'UAH - Ukrainian Hryvnia', image: `${process.env.PUBLIC_URL}/assets/images/UAH.svg`},
        { value: 'EUR', label: 'EUR - Euro', image: `${process.env.PUBLIC_URL}/assets/images/EUR.svg` },
    ];
        ...
        <div className="converter-options">
            ...
            <div className='converter-options-wrapper'>
                 ...
                 formatOptionLabel={currency => (
                    ...
                    <img src={currency.image} alt="flag" 
