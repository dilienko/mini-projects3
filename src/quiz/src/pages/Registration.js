        ...
        createUserWithEmailAndPassword(auth, data.email, data.password)
            .then((userCredential) => {
                updateProfile(userCredential.user, {
                    ...
                    photoURL: "https://img.freepik.com/free-icon/cat_318-599485.jpg",
                })
                    .then(() => {
                        setIsLoading(false);
                        swal({ title: "You successfully registered", icon: "success" }).then(() =>
                            navigate("/login")
                        );
                    })
                    .catch((error) => {
            ...
            .catch((err) => {
                ...
                if (err.code === "auth/email-already-in-use") {
                    ...
                    swal({
                        title: "An error occurred during registration. Try sign up later",
                        icon: "error",
                    });
                }
            });
